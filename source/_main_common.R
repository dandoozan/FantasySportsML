...
F.BORUTA.CONFIRMED = c('FPPG', 'GamesPlayed', 'Salary', 'InjuryIndicator', 'InjuryDetails', 'NF_Min', 'NF_Pts', 'NF_Reb', 'NF_Ast', 'NF_Stl', 'NF_Blk', 'NF_TO', 'NF_FP', 'RG_ceil', 'RG_floor', 'RG_points', 'RG_ppdk', 'RG_overunder', 'RG_total', 'RG_contr', 'RG_pownpct', 'RG_deviation', 'RG_minutes', 'RG_rank', 'RG_salary15', 'RG_salary19', 'RG_rank20', 'RG_salary20', 'RG_salary28', 'RG_salary43', 'RG_salary50', 'RG_salary58', 'RG_points15', 'RG_points19', 'RG_points20', 'RG_points28', 'RG_points43', 'RG_points50', 'RG_points51', 'RG_points58', 'RG_ADV_POW_AST', 'RG_ADV_POW_PTS', 'RG_ADV_POW_REB', 'RG_ADV_POW_STL', 'RG_ADV_USGPCT', 'RG_START_Order', 'RG_START_Starter', 'RG_MW_dk_current', 'RG_MW_fa_current', 'RG_MW_y_current', 'RG_MW_dd_current', 'RG_MW_dd_change', 'RG_MW_rstr_current', 'RG_MW_fdft_current', 'NBA_S_P_TRAD_GP', 'NBA_S_P_TRAD_W', 'NBA_S_P_TRAD_L', 'NBA_S_P_TRAD_MIN', 'NBA_S_P_TRAD_FGM', 'NBA_S_P_TRAD_FGA', 'NBA_S_P_TRAD_FG_PCT', 'NBA_S_P_TRAD_FG3A', 'NBA_S_P_TRAD_FTM', 'NBA_S_P_TRAD_FTA', 'NBA_S_P_TRAD_DREB', 'NBA_S_P_TRAD_REB', 'NBA_S_P_TRAD_AST', 'NBA_S_P_TRAD_TOV', 'NBA_S_P_TRAD_STL', 'NBA_S_P_TRAD_PF', 'NBA_S_P_TRAD_PFD', 'NBA_S_P_TRAD_PTS', 'NBA_S_P_TRAD_PLUS_MINUS', 'NBA_S_P_ADV_OFF_RATING', 'NBA_S_P_ADV_DEF_RATING', 'NBA_S_P_ADV_AST_PCT', 'NBA_S_P_ADV_AST_TO', 'NBA_S_P_ADV_AST_RATIO', 'NBA_S_P_ADV_OREB_PCT', 'NBA_S_P_ADV_DREB_PCT', 'NBA_S_P_ADV_REB_PCT', 'NBA_S_P_ADV_TM_TOV_PCT', 'NBA_S_P_ADV_EFG_PCT', 'NBA_S_P_ADV_TS_PCT', 'NBA_S_P_ADV_USG_PCT', 'NBA_S_P_ADV_PACE', 'NBA_S_P_ADV_PIE', 'NBA_S_P_ADV_FGM_PG', 'NBA_S_P_ADV_FGA_PG', 'NBA_S_P_DEF_DEF_RATING', 'NBA_S_P_DEF_PCT_DREB', 'NBA_S_P_DEF_PCT_STL', 'NBA_S_P_DEF_OPP_PTS_OFF_TOV', 'NBA_S_P_DEF_OPP_PTS_2ND_CHANCE', 'NBA_S_P_DEF_OPP_PTS_FB', 'NBA_S_P_DEF_OPP_PTS_PAINT', 'NBA_PB_PLAYER_WEIGHT', 'NBA_PB_DRAFT_NUMBER', 'NBA_S_T_TRAD_FG_PCT', 'NBA_S_T_TRAD_FG3M', 'NBA_S_T_TRAD_FG3A', 'NBA_S_T_TRAD_FG3_PCT', 'NBA_S_T_TRAD_TOV', 'TEAM_RG_points', 'TEAMMATES_RG_points')
